<div class="modal fade" id="edit-course-{{$showcourse->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('update-course-route',$showcourse->id) }}" method="post" autocomplete="off">
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-lg-6">
