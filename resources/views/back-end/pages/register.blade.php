...
<body class="signup-page">
    <div class="signup-box">
        <div class="logo">
            <a href="javascript:void(0);"><b>Lonestar</b>Enterprise</a>
            ...
            <div class="body">
                <form id="sign_up" action="{{ route('save-user-route') }}" method="POST">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="name" placeholder="Name Surname" required autofocus value="{{ old('name') }}">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="password" class="form-control" name="confirm-password" minlength="6" placeholder="Confirm Password" required>
