...
<footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Research Production Extension</h3>
            <p>
              Research, Production & Extension Division <br>
              Jomo Kenyatta University of Agriculture and Technology<br>
              P.O. Box 62,000 – 00200 NAIROBI, KENYA <br><br>
              <strong>Phone:</strong> +254-067-52711<br>
              <strong>Fax:</strong> +254-06752164<br>
              <strong>Email:</strong> dvc@rpe.jkuat.ac.ke<br>
            </p>
          </div>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">My subscribed courses</a></li>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Research Production extension, JKUAT</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
